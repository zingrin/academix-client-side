...
const careerData = [
  ...
  },
  {
    ...
    image: "https://i.ibb.co/d4t54dQ4/cheerful-beautiful-young-asian-woman-feeling-happy-smiling-camera-while-traveling-street-downtown-ci.jpg",
  },
  {
    title: "Cloud Computing",
    description: "Master AWS, Azure, and cloud infrastructure.",
    image: "https://i.ibb.co/tpYxhSGG/smiling-young-financial-manager-showing-charts-graphs-white-board-1098-19846.jpg",
  },
  {
    title: "Cyber Security",
    description: "Protect systems and networks from threats.",
    image: "https://i.ibb.co/7tgkg3Ls/high-angle-man-artist-painting-canvas-23-2148422150.jpg",
  },
  {
  ...
  },
  {
    ...
    image: "https://i.ibb.co/4RStGgww/woman-photographer-working-23-2148503530.jpg",
  },
  {
    ...
    <div className="max-w-6xl mx-auto py-12 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {cardsToShow.map((career, index) => (
          <div
            key={index}
            className="bg-base-200 shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition"
          >
            <img
              src={career.image}
              alt={career.title}
      ...
      {!showAll && (
        <div className="text-center mt-8">
          <button
            ...
            className="bg-blue-600 text-white dark:bg-blue-500 dark:hover:bg-blue-600 px-6 py-2 rounded-lg hover:bg-blue-700 transition"
          >
